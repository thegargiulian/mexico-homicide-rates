...
# Maintainers: MG
# =========================================
# mexico-homicide-rates/census-data/import-muni/src/import-inegi-2010.R
...
parser$add_argument("--input", default = "input/iter_00_cpv2010.csv")
# retrieved using https://www.inegi.org.mx/programas/ccpv/2010/#Datos_abiertos
